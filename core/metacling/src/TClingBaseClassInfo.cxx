...
TClingBaseClassInfo::TClingBaseClassInfo(cling::Interpreter* interp,
   ...
   : fInterp(interp), fClassInfo(nullptr), fFirstTime(true), fDescend(false),
     fDecl(nullptr), fIter(0), fBaseInfo(nullptr), fOffset(0L), fClassInfoOwnership(true)
{
...
TClingBaseClassInfo::TClingBaseClassInfo(cling::Interpreter* interp,
   ...
   : fInterp(interp), fClassInfo(nullptr), fFirstTime(true), fDescend(false),
     fDecl(nullptr), fIter(0), fBaseInfo(nullptr), fOffset(0L), fClassInfoOwnership(false)
{
